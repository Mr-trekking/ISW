...
void kOmegadensity<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicTurbulenceModel>
kOmegadensity<BasicTurbulenceModel>::kOmegadensity
(
...
template<class BasicTurbulenceModel>
bool kOmegadensity<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegadensity<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
